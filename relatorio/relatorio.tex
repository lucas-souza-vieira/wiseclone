...
Para atender ao propósito acadêmico de testar as ferramentas de segurança, o sistema foi desenvolvido \textbf{intencionalmente} com diversas vulnerabilidades. O sucesso do pipeline consiste em conseguir detectá-las. As vulnerabilidades injetadas foram:
